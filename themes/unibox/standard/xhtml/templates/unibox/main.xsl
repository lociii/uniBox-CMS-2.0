	...
	<xsl:template match="/">
		...
		<html lang="de" id="unibox_backend">
			<head>
				...
				<script src="{/root/unibox/html_base}{/root/unibox/theme_base[@template='main']/path}/scripts/help.js" type="text/javascript"></script>
			...
			<body>
				...
				<div id="page_infobar">
					<div class="box_gradient box_gradient_large box_gradient_header">
						...
						<div class="left_float">
							<h1 class="invisible"><xsl:value-of select="/root/translations/TRL_TEMPLATE_PAGE_TO_ADMINISTRATE" /></h1><strong><xsl:value-of select="/root/unibox/user_name" /> @ </strong><a href="{/root/unibox/html_base}" rel="external"><xsl:value-of select="/root/unibox/page_name" /></a>
						</div>
				...
				<script type="text/javascript">
					<![CDATA[
						toggle_instanthelp(']]><xsl:value-of select="$theme_base" /><![CDATA[', ']]><xsl:value-of select="/root/translations/TRL_INSTANTHELP_SHOW" /><![CDATA[', ']]><xsl:value-of select="/root/translations/TRL_INSTANTHELP_VANISH" /><![CDATA[');
					]]>
				</script>
			</body>
		</html>
