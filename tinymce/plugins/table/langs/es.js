...
row_after_desc : 'Insert una fila despu�s',
delete_row_desc : 'Eliminar fila',
col_before_desc : 'Insertar una columna antes',
col_after_desc : 'Insertar una columna despu�s',
...
paste_row_after_desc : 'Pegar fila despu�s',
id : 'Id',
style: 'Estilo',
langdir : 'Direcci�n del texto',
langcode : 'C�digo del idioma',
...
missing_scope: '�Est�s seguro que quieres continuar sin especificar el alcance para esta celda de tipo cabecera? Sin ello, puede dificultar a algunos usuarios con discapacidades el poder entender el contenido o los datos mostrados en la tabla.',
