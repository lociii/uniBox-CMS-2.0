...
// BEGIN ADD BY MEDIA SOMA
	var align = getStyle(trElm, 'textAlign');
	var valign = getStyle(trElm, 'verticalAlign');
...
// BEGIN ADD BY MEDIA SOMA
	tr_elm.style.textAlign = getSelectValue(formObj, 'align');
	tr_elm.style.verticalAlign = getSelectValue(formObj, 'valign');
// END ADD BY MEDIA SOMA
