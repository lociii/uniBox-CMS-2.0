...
// BEGIN ADD BY MEDIA SOMA
	...
	var align = getStyle(tdElm, 'textAlign');
	var valign = getStyle(tdElm, 'verticalAlign');
...
// BEGIN ADD BY MEDIA SOMA
	td.style.textAlign = getSelectValue(formObj, 'align');
	td.style.verticalAlign = getSelectValue(formObj, 'valign');
...
/* CUT BY MEDIA SOMA
	...
	// Set styles
	td.style.width = formObj.width.value;
	td.style.height = formObj.height.value;
