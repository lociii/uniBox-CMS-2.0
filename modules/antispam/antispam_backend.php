...
class ub_antispam_backend
{
    ...
    */
	...
	public function antispam_group_administrate()
	{
        ...
        $pagebrowser = ub_pagebrowser::get_instance('antispam_group_administrate');
        $pagebrowser->process($sql_string, 25);

        $admin = ub_administration::get_instance('antispam_group_administrate');
        // add header fields
	...
	public function antispam_administrate_show()
	{
        ...
        $result = $this->unibox->db->query($sql_string, 'failed to select antispam entries');

        $pagebrowser = ub_pagebrowser::get_instance('antispam_administrate');
        $pagebrowser->process($sql_string, 25);

        $admin = ub_administration::get_instance('antispam_administrate');
        // add header fields
        $admin->add_field('TRL_NAME', 'b.string_value');
        ...
        $admin->show('antispam_administrate');
	}
