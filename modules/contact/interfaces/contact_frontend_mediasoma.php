...
class ub_contact_frontend_mediasoma
{
    /**
    * $version
    *
    ...
    */
    ...
    {
        return ub_contact_frontend_mediasoma::version;
    }
    ...
    */
    public static function get_instance()
    {
        if (is_null(self::$instance))
            self::$instance = new ub_contact_frontend_mediasoma;
    ...
    */
    ...
    public function contact_process()
    {
        ...
        $email->set_replacement('contact_person', ub_functions::unescape($this->unibox->session->env->form->contact->data->contact_person));
        $email->set_replacement('location_name', ub_functions::unescape($this->unibox->session->env->form->contact->data->location_name));
    ...
    {
        $this->unibox->set_content_title('TRL_CONTACT');
